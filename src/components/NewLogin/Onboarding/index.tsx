...
export function AccountBox(props: any) {
  ...
  const [active, setActive] = useState<"login" | "reset">("login");
  ...
  const contextValue: AccountContextType = { switchToReset, switchToLogin };
        ...
        <TopContainer>
          ...
          {active === "reset" && (
            <HeaderContainer>
              ...
              <SmallText>Enter email to reset!</SmallText>
            </HeaderContainer>
          )}
        </TopContainer>
        <InnerContainer>
          {active === "login" && <LoginForm />}
          {active === "reset" && <PasswordResetForm />}
        </InnerContainer>
      </BoxContainer>
