...
export const TeamLeadSideBar = ({ step, selectStep }: Props) => {
 const list = [
    {
      name: "Dashboard",
    ...
    },
    {
      name: "Projects",
      icon: (
        <IoFolderOpen size={20} color={step === 2 ? "#27ae60" : "grey"} />
      ),
    },
    {
      name: "Settings",
      icon: (
        <AiTwotoneSetting size={20} color={step === 3 ? "#27ae60" : "grey"} />
      ),
    },
    {
      name: "Logout",
      icon: (
        <AiOutlineLogout size={20} color={step === 4 ? "#27ae60" : "grey"} />
      ),
    },
  ]
